...
> **Historical as of 2026-09-14.** This registry is no longer live: one active
> repository-root session (Codex or Claude Code) is the integrator and executor;
> the per-module Codex sessions below are provenance only. Their historical UI
> labels below omit the retired suffix «Исполнитель» requested by the Product
> Owner; thread IDs preserve identity.
