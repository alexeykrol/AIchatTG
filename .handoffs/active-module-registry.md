...
|---|---|---|---|---|
| Moderator + Assistant runtime | user-visible-workstream | `Telegram assistant — Executor 2` (`019fbf1f-e000-7ce1-a485-a01567d13225`) | permanent integrator | independent local port chartered; no live cutover |
